                ...
                <div className="mb-6">
                    ...
                    <div className="flex gap-2 border-b border-slate-200 dark:border-slate-700">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-3 font-medium transition-all ${activeTab === 'overview'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-3 font-medium transition-all ${activeTab === 'portfolio'
                                    ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                    : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-3 font-medium transition-all ${activeTab === 'dependencies'
                                    ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                    : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100'
                                }`}
                        >
